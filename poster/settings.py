...
"""
# Email configurations for developer mode
...
EMAIL_FILE_PATH = os.path.join(BASE_DIR, "sent_emails")
"""
#these are, in below, for production mode
...
#CKEDITOR_JQUERY_URL = os.path.join(STATIC_URL,'vendor/jquery/jquery.min.js')

CKEDITOR_CONFIGS = {
    'default': {
        #'toolbar': 'full',  #ckeditordeki mevcut butun araclari toolbar a ekleme
        #'height': '100%',
        #'width': '100%',
        'width':'auto',
